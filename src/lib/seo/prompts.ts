...
- ПЛОТНОСТЬ ЗАГОЛОВКОВ: дай 10-14 секций (H2+H3 суммарно) — НЕ больше 14, даже при большом целевом объёме. Объём добирается ДЛИНОЙ секций (увеличивай word_count), а НЕ числом заголовков. Соотношение примерно 1 H2 на 2-3 H3. Покрой главные sub-intents и под-вопросы, приоритет — самым важным для коммерции/интента; второстепенное объединяй, не дроби на десятки мелких H3.
- СУЩНОСТИ: для крупных секций 4-6 сущностей с весами, для мелких H3 — 2-3. НЕ 1 на секцию, но и не раздувай.
