...
- SUMMARY: 3-5 предложений с КОНКРЕТНЫМИ числовыми ориентирами (расстояние в км, время в мин/ч, диапазоны цен в валюте), которые копирайтер впишет дословно. Не общие фразы.
