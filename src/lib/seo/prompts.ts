...
- ПОДАЧА (ПРИОРИТЕТ НАД copywriter_notes): основа — связные абзацы по 2-4 предложения. На ВСЕ секции этого задания — максимум ОДИН список; в процедурной секции (регистрация, пошаговая инструкция, чек-лист документов) список ЖЕЛАТЕЛЕН (нумерованные шаги), в остальных — только проза. Если copywriter_notes предлагают больше списков — ИГНОРИРУЙ: содержание из notes, формат отсюда.
