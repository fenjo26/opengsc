...
- ГЛУБИНА И ВЛОЖЕННОСТЬ: разбивай крупные H2 на 2-4 вложенных H3. H3 — это ОТДЕЛЬНЫЙ элемент массива sections с "h_level":"H3", идущий сразу ПОСЛЕ своего H2. Не делай плоский список из одних H2.
- ПЛОТНОСТЬ ЗАГОЛОВКОВ: масштабируй под объём ~1 заголовок на 70-120 слов. При целевом объёме ≥1200 слов дай НЕ МЕНЬШЕ 12 секций (H2+H3 суммарно), при ≥1800 — 16-22. Покрой все реальные sub-intents и под-вопросы, а не 4-5 общих блоков.
